            ...
            <Element name="pricing">
                <div className="container">
                    <div
                        ...
                        <h3 className="h3 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-14 max-w-lg text-center text-p4 max-md:mb-11 max-sm:max-w-sm">Flexible
                            Pricing for teams of all sizes</h3>
                    ...
                    <div
                        className="scroll-hide relative z-2 -mt-20 flex items-start max-xl:gap-5 max-xl:overflow-auto max-xl:pt-6">
